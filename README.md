...
- **[AuraHR (Premium SaaS HR Portal & Mobile Simulator)](https://github.com/SadeepSachintha/AuraHR):** A high-fidelity, interactive, multi-tenant SaaS HR management dashboard and simulated mobile self-service app built side-by-side. Features a secure dual-mode backend (Netlify Serverless Functions and local PHP Proxy) connected to a Supabase Cloud PostgreSQL database with secret database keys, X-Company-ID tenant isolation, and localStorage offline fallback.
